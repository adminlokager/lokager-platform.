...
export const HeroSection = ({ onSearch }) => {
  ...
  return (
    <section id="top" data-testid="hero-search-section" className="relative overflow-hidden bg-ivory pt-[68px] lg:pt-[76px]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 pb-16 pt-12 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:px-12 lg:pb-24 lg:pt-20">
        <div className="relative z-10">
          ...
          <motion.p {...rise(0.2)} className="mt-6 max-w-xl font-sans text-base sm:text-lg leading-relaxed text-charcoal-soft/90">
          ...
          <motion.p {...rise(0.42)} className="mt-5 font-sans text-sm text-charcoal-soft/70">
